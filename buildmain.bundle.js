...
/******/
/******/ 	// define a função getter para exportações de harmonia
...
/******/ 	};
/******/
/******/ 	// Função GetDefaultExport para compatibilidade com módulos não-harmonizados
...
try {
	for (var _iterator = document.querySelectorAll('h2 a')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		var node = _step.value;

		node.addEventListener('mouseenter', function (evt) {
			_animejs2.default.remove(evt.target);
			(0, _animejs2.default)({
				targets: evt.target,
				scale: 1.1,
				duration: 500
...
"use strict";
/* injeção de webpack var */(function(global) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;

var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };

/* Julian Garnier 2017 lançado sob a licença do MIT */
...
/* injeção de webpack var */}.call(exports, __webpack_require__(2)))
...
// Isso funciona em modo não estrito
g = function () {
	return this;
}();

try {
	// Isso funciona se eval for permitido (veja CSP)
	g = g || Function("return this")() || (1, eval)("this");
} catch (e) {
	// Isso funciona se a referência da janela estiver disponível
	if ((typeof window === "undefined" ? "undefined" : _typeof(window)) === "object") g = window;
}

// g ainda pode ser indefinido, mas nada a ver... 
// Retornamos indefinidos, em vez de nada aqui, 
// então é mais fácil lidar com este caso. if(!global) {...}
